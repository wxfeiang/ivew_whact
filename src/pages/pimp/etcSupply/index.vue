  ...
  methods: {
    ...
    async getSupplyOCR() {
      ...
      try {
        ...
        if (iReturn.status === 200 && iReturn.data) {
          let takeProvince = iReturn.data.takeProvince ? iReturn.data.takeProvince : '甘肃省'
          let takeCity = iReturn.data.takeCity ? iReturn.data.takeCity : '兰州市'
          let takeCountry = iReturn.data.takeCountry ? iReturn.data.takeCountry : '城关区'
          this.ocrData.idCard.name = iReturn.data.userName ? iReturn.data.userName : ''
          this.ocrData.idCard.idNo = iReturn.data.ownerIdNum ? iReturn.data.ownerIdNum : ''
          this.ocrData.car.carHeadPlateNo = iReturn.data.vehicleId ? iReturn.data.vehicleId : ''
          this.ocrData.car.plateNoColor = iReturn.data.vehicleColor ? iReturn.data.vehicleColor : ''
          this.ocrData.vehicle.plateNo = iReturn.data.vehicleId ? iReturn.data.vehicleId : ''
          this.ocrData.vehicle.vehicleType = iReturn.data.vehicleType ? iReturn.data.vehicleType : ''
          this.ocrData.vehicle.owner = iReturn.data.ownerName ? iReturn.data.ownerName : ''
          this.ocrData.vehicle.useCharacter = iReturn.data.usecharacter ? iReturn.data.usecharacter : ''
          this.ocrData.vehicle.model = iReturn.data.vehicleModel ? iReturn.data.vehicleModel : ''
          this.ocrData.vehicle.vin = iReturn.data.vin ? iReturn.data.vin : ''
          this.ocrData.vehicle.engineNo = iReturn.data.engineNum ? iReturn.data.engineNum : ''
          this.ocrData.vehicle.registerDate = iReturn.data.registerDate ? iReturn.data.registerDate : ''
          this.ocrData.vehicle.issueDate = iReturn.data.issueDate ? iReturn.data.issueDate : ''
          this.ocrData.vehicle.approvedCount = iReturn.data.approvedCount ? iReturn.data.approvedCount : ''
          this.ocrData.vehicle.splateNo = iReturn.data.vehicleId ? iReturn.data.vehicleId : ''
          this.uAd.userName = iReturn.data.ownerName ? iReturn.data.ownerName : ''
          this.uAd.idNumber = iReturn.data.ownerIdNum ? iReturn.data.ownerIdNum : ''
          this.uAd.plateNo = iReturn.data.vehicleId ? iReturn.data.vehicleId : ''
          this.uAd.mobile = iReturn.data.tel ? iReturn.data.tel : ''
          this.uAd.pCode = iReturn.data.postCode ? iReturn.data.postCode : ''
          this.uAd.address = iReturn.data.address ? iReturn.data.address : ''
          this.uAd.regionSelect = `${takeProvince}-${takeCity}-${takeCountry}`
          this.ocrData.uFront = iReturn.data.imageId ? `${ocr.rootPath}${iReturn.data.imageId}` : null
          ...
          this.ocrData.vehicleMain = iReturn.data.vehicleImgOriId ? `${ocr.rootPath}${iReturn.data.vehicleImgOriId}` : null
          this.ocrData.vehicleSub = iReturn.data.vehicleImgDupId ? `${ocr.rootPath}${iReturn.data.vehicleImgDupId}` : null
          this.ocrData.carHead = iReturn.data.carImgId ? `${ocr.rootPath}${iReturn.data.carImgId}` : null
